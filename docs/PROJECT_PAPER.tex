...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item \textbf{The fusion-prior audit exposed sensitivity, a unit-of-analysis
        ...
        changed at most $0.3\%$ of bands. A code audit found that long sessions
        ...
        (134 completed sessions; replication max $|\Delta| = 6{\times}10^{-5}$), the
        honest picture is \emph{less} flattering than the exploratory one --- which
        is exactly why the rerun mattered: weight perturbations of $\pm 0.15$ flip a
        median $1.5\%$ and worst-case $10.4\%$ of session bands (not $0.3\%$),
        removing the genre multiplier flips $33.6\%$, and $\pm 0.05$ threshold
        shifts flip up to $26.1\%$. The stakes ranking stands --- thresholds and the
  ...
  \item \textbf{Channel contribution to the fused decision, measured on real
        ...
        produced had the other channels never been captured). On the pilot's 134
        ...
        flips $13.7\%$. Behaviour+voice reproduces the served decision exactly
        ($100\%$, mean $|\Delta\text{score}| = 0.002$) because typed chat was
        structurally absent in this pilot's no-chat title --- the
        availability-weighted design operating as intended. Two honest readings
...
the profile a daily screening figure must have.) Second, an honest null: the child-side reflection
