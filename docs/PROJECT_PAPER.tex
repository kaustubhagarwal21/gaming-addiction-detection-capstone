...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item A layered test program, all passing: a 54-test API suite (isolated database;
        ...
        together with Android Lint on
        every push), a \textbf{81-check functional sweep run in production auth mode} with real
  ...
  \item Robustness under load on free-tier hosting: pooled, probe-validated connections
        ...
        across 24 threads, zero errors). On the device side, state shared across the
