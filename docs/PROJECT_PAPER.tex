...
\begin{enumerate}[leftmargin=1.4em]
  ...
  \item Tamper resistance and resilient delivery: a self-restarting foreground service,
        ...
        --- and ``playing right now'', an offline retry queue so chat captured
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item A layered test program, all passing: a 35-test API suite (isolated database),
        a \textbf{75-check functional sweep run in production auth mode} with real
