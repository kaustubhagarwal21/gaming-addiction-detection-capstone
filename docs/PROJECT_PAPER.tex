...
share any method inflation, yet the model beats them); the pattern-versus-volume
...
$\rho{=}0.352$ ($\approx$$12\%$ shared variance) is modest in absolute terms with a
wide interval at $n{=}86$; it sits inside the $0.3$--$0.5$ range that
