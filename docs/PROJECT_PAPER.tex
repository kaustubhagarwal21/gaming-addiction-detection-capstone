...
scripts + the clean-Hindi Wikipedia counterweight; held-out Brier $0.066 \rightarrow 0.063$), fused with the keyword lexicon. The held-out set is
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item A layered test program, all passing: a 180-test API suite (isolated database;
        ...
        Android Lint with zero errors, and 100 JVM unit tests (run in CI) pin offline
