...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item A layered test program, all passing: a 67-test API suite (isolated database;
        ...
        Android Lint with zero errors, and 41 JVM unit tests (run in CI) pin the
