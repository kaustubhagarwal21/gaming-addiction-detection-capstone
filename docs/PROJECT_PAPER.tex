...
is grounded in \emph{nine real, open datasets}: the chat model reaches $0.96$
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item \textbf{Chat:} TF-IDF over a \emph{union} of word 1--2 grams and
        ...
        held-out Brier $0.061 \rightarrow 0.058$). The character channel was \emph{originally rejected} --- trained on
...
$0.061 \rightarrow 0.058$), fused with the keyword lexicon. The held-out set is
...
\midrule
Balanced held-out & 0.906 & 0.953 & optimistic view; PR-AUC 0.944 \\
General realistic stream @0.50 & 0.248 & 0.953 & 3.5\% toxic base rate \\
General realistic stream @0.95 (alert) & 0.426 & 0.280 & out-of-domain view \\
\bottomrule
\end{tabular}
\end{center}
...
$0.95$. The tables in this section report the retrained model.
...
\midrule
@0.95 (deployed alert threshold) & \textbf{0.962} & 0.334 & 0.496 \\
@0.90 (recall-preferring option, env-selectable) & 0.922 & 0.606 & 0.731 \\
@0.85 (near best F1; selectable via env) & 0.841 & 0.709 & 0.769 \\
@0.97 (high-severity marker) & 0.991 & 0.065 & 0.122 \\
\bottomrule
\end{tabular}
\end{center}
The promised secondary views on this in-domain set: ROC-AUC $0.922$ and MCC $0.517$
at the alert threshold ($0.698$ at the $0.90$ point; per-configuration values for
...
\midrule
Full recipe (deployed)            & 0.831 [0.813, 0.846] & 0.956 \\
$-$ keyword-lexicon fusion        & 0.820 [0.802, 0.836] & 0.972 \\
$-$ calibration                   & 0.841 [0.823, 0.856] & 0.969 \\
$-$ char\_wb n-grams              & 0.793 [0.774, 0.810] & 0.952 \\
$-$ Davidson corpus               & 0.780 [0.761, 0.797] & 0.885 \\
$-$ CONDA corpus (domain data)    & 0.512 [0.487, 0.535] & 0.982 \\
...
($+0.038$) and Davidson ($+0.051$, and $+0.071$ precision at the alert point) are
each significant. Two nuances: the keyword fusion buys only $+0.011$ PR-AUC
...
\textbf{calibration costs $0.010$ PR-AUC}: isotonic regression creates probability
...
\S\ref{sec:chatresults}, whose final held-out Brier (post-dedupe retrain) is
$0.061 \rightarrow 0.058$.
