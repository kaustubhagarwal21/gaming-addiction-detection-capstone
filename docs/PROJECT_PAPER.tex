...
alert threshold: \textbf{Devanagari PR-AUC $0.869$, precision $0.957$ / recall
$0.316$; romanised PR-AUC $0.871$, precision $0.973$ / recall $0.215$} ---
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item \textbf{Code-mixed text model and Hindi speech recognition.} The lexicon
        ...
        cost, so it needs on-device testing --- not a blind change. A third, smaller
