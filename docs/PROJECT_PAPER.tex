...
weighted ensemble of three classical machine-learning models, chosen over deep
alternatives for on-device privacy, deployability, SHAP explainability and
honesty of evaluation. Every model choice is backed by a measured bake-off,
