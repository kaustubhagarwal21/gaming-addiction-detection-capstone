...
just alerts); and (v)~an honest, realistic-stream evaluation with a live drift monitor,
...
accuracy characterised honestly in \S6 on open, reproducible evaluations.
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item A layered test program, all passing: a 58-test API suite (isolated database;
        ...
        Android Lint with zero errors, and 30 JVM unit tests (run in CI) pin the
