...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item A layered test program, all passing: a 55-test API suite (isolated database;
        ...
        Android Lint with zero errors, and 22 JVM unit tests (run in CI) pin the
        offline chat queue's delivery semantics, the WAV container encoding, and the
        parent-alert triage rules.
