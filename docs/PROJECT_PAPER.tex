...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item A layered test program, all passing: a 180-test API suite (isolated database;
        ...
        apps' MobSF scan (\texttt{bandit}: 44 medium findings, \emph{43 verified false
        ...
        confirmed by a committed-secret scan (\texttt{detect-secrets}) that no service-account
