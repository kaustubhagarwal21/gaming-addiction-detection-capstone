...
```
38 tests across the two apps pin the pure decision logic: the shared risk-label presentation (RiskPresentation, both apps), the offline chat queue's
