...
```
41 tests across the two apps pin the pure decision logic: profile-edit validation (ProfileValidation), the shared risk-label presentation (RiskPresentation, both apps), the offline chat queue's
