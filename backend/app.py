...
Clean REST API Backend — PES University Capstone PW26_SAS-03
...
def weekly_report_pdf():
    ...
    pdf.set_x(pdf.l_margin)
    pdf.multi_cell(pdf.epw, 5, _latin1('Report generated by AI Gaming Addiction Detection System — PES University Capstone PW26_SAS-03'))
